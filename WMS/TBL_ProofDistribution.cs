...
namespace WMS
{
    ...
    public partial class TBL_ProofDistribution
    {
        ...
        public Nullable<byte> CorrectionToED { get; set; }
        public Nullable<byte> AllEDCorrection { get; set; }
        public Nullable<byte> PEinCC { get; set; }
        public Nullable<byte> EDinCC { get; set; }
        public string Status { get; set; }
        public Nullable<System.DateTime> AcceptDate { get; set; }
        public Nullable<byte> Booked { get; set; }
        public Nullable<byte> SkipCEReview { get; set; }
    }
}
