    ...
    init: function (setting) {
        ...
        function buildmenu($anchors) {
            $anchors.each(function () { //loop through anchor links
                ...
                if (GetLastSegment().toLowerCase() == 'taskcalendar')
                    $submenu.wrap('<div class="subwrapper" style="z-index:' + ddiconmenu.startzindex + ';position:absolute;top:0;left:0;visibility:hidden"><div style="position:initial;overflow:hidden;left:0;top:0;width:100%;height:100%;"></div></div>')
